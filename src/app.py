...
activities = {
    ...
    "Soccer Team": {
        "description": "Train, practice teamwork, and compete in interschool soccer matches",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 22,
        "participants": ["liam@mergington.edu", "ava@mergington.edu"]
    },
    "Basketball Club": {
        "description": "Develop basketball skills and play friendly and competitive games",
    ...
    "Art Studio": {
        "description": "Explore drawing, painting, and mixed media visual arts",
